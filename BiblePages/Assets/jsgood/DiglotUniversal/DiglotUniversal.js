...
<div class="OtherMenu" id="more-links">
   ...
   <div class="copybuttons">
      <div class="dualplacement">
         <div class="controldiglot diglot2 smallfont" onclick="copyEnglish()">COPIAR INGLÉS</div>
         <div class="controldiglot diglot2 smallfont" onclick="copyTagalog()">COPY TAGALOG</div>
      </div>
      <div class="soloplacement">
         <div class="controldiglot diglot2 smallfont" onclick="copyBoth()">COPIAR BILINGÜE</div>
      </div>
   </div>
