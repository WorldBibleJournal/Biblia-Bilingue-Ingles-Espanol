class DiglotThumbMenu extends HTMLElement {
		...
		this.innerHTML = `
                      <div id="biblemenuanimation">
                        <div class="testamentsholderthumb">
                            ...
                            <a href="../../searchbible.html"><div id="searchhere"><span class="searchside">SEARCH THE ENTIRE BIBLE WITH SEARCH PAGE</span><img src="../Assets/images/journal/search.svg" class="searchright" style="min-width: 20px; max-width:200px; min-height: 20px; max-height:200px; height:auto; width:20%;"></div></a>
 ...
 <div class="books thumbindex" id="journalholderDesktop">
  ...
  <div class="thumbindex hidelandscape">
...
<br/>JESUS, SAVE ALL OF US.<br/><br/><br/><br/><br/><br/>FORGIVE OUR SINS.
    ...
    <span id="openbiblemenu">BIBLE <span class="desktopmenu">MENU&nbsp;</span>☰</span>
                      <span id="closebiblemenu">BIBLE <span class="desktopmenu">MENU&nbsp;</span>✖</span>
                  </div>
