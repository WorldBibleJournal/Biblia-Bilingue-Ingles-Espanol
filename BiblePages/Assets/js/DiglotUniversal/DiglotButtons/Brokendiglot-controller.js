class DiglotController extends HTMLElement {
  connectedCallback () {
...
<div id="controls displaynoneMenu">
    <div class="controls-row">
        ...
        <div class="control-btn" onclick="showTagalogOnly()"> SPANISH </div>
    ...
    <div class="controls-row">
        ...
        <div class="control-btn" onclick="copyTagalog()"> COPIAR ESPAÑOL </div>
